...
docker rm "${container_name}_headless"
    ...
    if [[ "$container_name" == "chrome_linux_128_0_6613_36" || "$container_name" == "chrome_linux_129_0_6666_0" || "$container_name" == "chrome_linux_130_0_6710_0" ]]; then
        docker run --name "${container_name}_headless" --env "CONTAINER_NAME:${container_name}" -v "$(pwd)/${d}:/chromium" -v "$(pwd)/puppeteer-switch-jsta-fpjs.js:/home/pptruser/puppeteer.js:ro" -v "$(pwd)/get_systeminformation.js:/home/pptruser/get_systeminformation.js:ro" -v "$(pwd)/../database/.env:/home/database/.env:ro" -v "$(pwd)/data:/home/pptruser/data" --network fp-docker -d puppeteer-xvfb:latest sh -c "Xvfb :99 -screen 0 1920x1080x24 -nolisten tcp & node /home/pptruser/puppeteer.js --headless-new"
    else
        docker run --name "${container_name}_headless" --env "CONTAINER_NAME:${container_name}" -v "$(pwd)/${d}:/chromium" -v "$(pwd)/puppeteer-switch-jsta-fpjs.js:/home/pptruser/puppeteer.js:ro" -v "$(pwd)/get_systeminformation.js:/home/pptruser/get_systeminformation.js:ro" -v "$(pwd)/../database/.env:/home/database/.env:ro" -v "$(pwd)/data:/home/pptruser/data" --network fp-docker -d puppeteer-xvfb:latest sh -c "Xvfb :99 -screen 0 1920x1080x24 -nolisten tcp & node /home/pptruser/puppeteer.js --headless"
    fi
    docker run --name "${container_name}" --env "CONTAINER_NAME:${container_name}" -v "$(pwd)/${d}:/chromium" -v "$(pwd)/puppeteer-switch-jsta-fpjs.js:/home/pptruser/puppeteer.js:ro" -v "$(pwd)/get_systeminformation.js:/home/pptruser/get_systeminformation.js:ro" -v "$(pwd)/../database/.env:/home/database/.env:ro" -v "$(pwd)/data:/home/pptruser/data" --network fp-docker -e "DISPLAY=:99" -e "QT_X11_NO_MITSHM=1" -d puppeteer-xvfb:latest sh -c "Xvfb :99 -screen 0 1920x1080x24 -nolisten tcp & node /home/pptruser/puppeteer.js"
done
