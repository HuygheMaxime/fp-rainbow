...
function startServer() {
    http.createServer(function(req, res) {
        console.log(req.url);
        fps = {}; // Reset value of the last request
        ...
        if (req.method == 'POST') {
            ...
            req.on('end', function() {
                ...
                //var log = JSON.parse(parsed.log);
                var filename = ident.replace(/\n/g,""); // Json file name with attribute of the fp
                ...
                fileSystem.writeFileSync('./data/'+filename+'.json', JSON.stringify(fps), 'utf-8');
            ...
            if (req.url.indexOf("/stat") == 0) {
                ...
                //var b1 = params[0].substr(params[0].indexOf("c1=") + 3).replace(/-/g, "=");
                //var b2 = params[1].substr(params[1].indexOf("c2=") + 3).replace(/-/g, "=");
                        ...
                        if (fps[ids[i]][all_keys[k]] === undefined) {
                            ...
                            if (fps[ids[i]][all_keys[k]].length == 1) {
                                if (d.indexOf(fps[ids[i]][all_keys[k]][0]) == -1 && 
                                    !JSON.stringify(fps[ids[i]][all_keys[k]]).includes('function')) d.push(fps[ids[i]][all_keys[k]][0]);
                                /*if (JSON.stringify(fps[ids[i]][all_keys[k]]).includes('function')) {
                                    console.log(fps[ids[i]][all_keys[k]]);
                                }*/
                            }
                        }
                    }
                ...
                if (req.url.indexOf("/delete") == 0) {
                    ...
                    //var identifier = req.url.substr(req.url.indexOf("?id=") + 4);
